    ...
    for (const consultancySchemas of consultancy) {
      await pool
        ...
        .input(
          "title",
          sql.NVarChar,
          consultancySchemas.faculty_name || "Unknown"
        )
        .input(
          "sanctionedDate",
          sql.Date,
    ...
    for (const eventsAttendedSchema1 of eventsAttended) {
      await pool
        ...
        .input(
          "fromDate",
          sql.Date,
          validateDate(eventsAttendedSchema1.fromDate) || new Date()
        )
        .input(
          "toDate",
          sql.Date,
          validateDate(eventsAttendedSchema1.toDate) || new Date()
        )
        .input(
          "organizer",
          sql.NVarChar,
          eventsAttendedSchema1.organizer || "Unknown"
        )
        .input("venue", sql.NVarChar, eventsAttendedSchema1.venue || "Unknown")
        .input(
          "sponsor",
          sql.NVarChar,
          eventsAttendedSchema1.sponsor || "Unknown"
        )
        .input(
          "targetAudience",
          sql.NVarChar,
          eventsAttendedSchema1.targetAudience || "Unknown"
        )
        .input("employee_id", sql.NVarChar, facultyId || "Unknown ID")
        .input(
          "nameofevent",
          sql.NVarChar,
          eventsAttendedSchema1.nameofevent || "Unknown"
        )
        .input(
          "typeofevent",
          sql.NVarChar,
          eventsAttendedSchema1.typeOfEvent || "Unknown"
        )
    ...
    for (const eventsOrganizedSchema1 of eventsOrganized) {
      await pool
        ...
        .input(
          "typeofevent",
          sql.NVarChar,
          eventsOrganizedSchema1.typeOfEvent || "Unknown"
        )
        .input(
          "nameofevent",
          sql.NVarChar,
          eventsOrganizedSchema1.nameofevent || "Unknown"
        )
        .input(
          "fromDate",
          sql.Date,
          eventsOrganizedSchema1.fromDate || new Date()
        )
        .input("toDate", sql.Date, eventsOrganizedSchema1.toDate || new Date())
        .input(
          "organizer",
          sql.NVarChar,
          eventsOrganizedSchema1.organizer || "Unknown"
        )
        .input("venue", sql.NVarChar, eventsOrganizedSchema1.venue || "Unknown")
        .input(
          "sponsor",
          sql.NVarChar,
          eventsOrganizedSchema1.sponsor || "Unknown"
        )
        .input(
          "targetAudience",
          sql.NVarChar,
          eventsOrganizedSchema1.targetAudience || "Unknown"
        )
        .input("employee_id", sql.NVarChar, facultyId)
