...
const steps: Step[] = [
  {
    ...
    fields: [
      ...
      "dependentsSchema.maritalstatus",
...
export default function Form() {
 ...
 useEffect(() => {
  ...
  // after your existing const { control, register, watch, … } = useForm…
const religion       = watch("personalSchema.religion");
const caste          = watch("personalSchema.caste");
const category       = watch("personalSchema.category");
const maritalStatus  = watch("dependentsSchema.maritalstatus");
            ...
            {currentStep === 0 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <FormField
                    label="Accout Holder Name(according to Bank Records)"
...
{/* 
                    ...
                    <FormField
                      label="University"
                      stepsReference={`educationSchema.${index}.university`}
                      type="text"
                    />
                    <FormField
                      label="Institution"
            ...
            {currentStep === 0 && (
              ...
              >
                ...
                <div>
                  ...
                  <select
                    {...register("dependentsSchema.maritalstatus")}
                    className="mt-1 block w-full p-2 rounded-md border bg-gray-50 border-gray-300 shadow-sm"
                  >
                ...
                <div>
                  ...
                  {maritalStatus === "Unmarried" ? (
                    <input
                      ...
                      id="spouseName"
                      {...register("dependentsSchema.spouseName")}
                      className="mt-1 w-full p-2 rounded-md border bg-gray-100 cursor-not-allowed"
                    />
                  ) : (
                    <FormField
                      label=""
                ...
                <div>
                  ...
                  {maritalStatus === "Unmarried" ? (
                    <input
                      ...
                      value={0}
                      id="children"
                      {...register("dependentsSchema.children")}
                      className="mt-1 w-full p-2 rounded-md border bg-gray-100 cursor-not-allowed"
                    />
                  ) : (
                    <FormField
                    ...
                    <table className="table-auto w-full text-left mt-2">
                      <thead>
                        <tr>
                          ...
                          <th className="font-medium text-gray-700">University</th>
                      ...
                      try {
                        ...
                        if (response.ok) {
                          ...
                          if (responseData.success) {
                            ...
                            router.push(
                              `/faculty/faculty_reg/academic/${facultyId}`
                            );
                            reset();
                          } else {
                            alert(
