...
export const personalSchema = z.object({
  ...
  nationality: z.string().min(1, { message: "Nationality is required" }).optional().or(z.literal("Indian")),
...
export const financialSchema = z.object({
  ...
  typeOfAccount: z.string().min(3, {  message: "Type of account is required" }),
...
export const educationSchema = z.array(
  ...
  z.object({
    ...
    // usn: z.string().min(1, { message: "USN is required" }).optional(),
    ...
    directCorr:z.string().min(3, {
      message: "Direct/Correspondence is required",
    }),
