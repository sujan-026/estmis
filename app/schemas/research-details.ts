...
export const nationalJournalDetailsSchema = z.array(
  z.object({
    ...
    publishedUnder: z
      .enum(["Web of Science", "Scopus", "Q1", "Q2", "Q3"])
      .optional(),
...
export const internationalConferenceDetailsSchema =
  nationalConferenceDetailsSchema; // Reuse the schema
